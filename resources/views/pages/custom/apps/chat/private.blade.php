                            ...
                            <div class="card-body">
                                ...
                                <div class="mt-7 scroll scroll-pull">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="d-flex flex-column">
                                                <a href="#"
                                                    ...
                                                    Pears</a>
                                                <span class="text-muted font-weight-bold font-size-sm">Head
                                                    of Development</span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mb-5">
                                        ...
                                        <div class="d-flex flex-column align-items-end">
                                            <span class="text-muted font-weight-bold font-size-sm">7
                                                hrs</span>
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mb-5">
                                        ...
                                        <div class="d-flex flex-column align-items-end">
                                            <span class="text-muted font-weight-bold font-size-sm">3
                                                hrs</span>
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mb-5">
                                        ...
                                        <div class="d-flex flex-column align-items-end">
                                            <span class="text-muted font-weight-bold font-size-sm">2
                                                days</span>
                                        </div>
                                    </div>
                                    <!--end:User-->
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mb-5">
                                        ...
                                        <div class="d-flex flex-column align-items-end">
                                            <span class="text-muted font-weight-bold font-size-sm">5
                                                mins</span>
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mb-5">
                                        ...
                                        <div class="d-flex flex-column align-items-end">
                                            <span class="text-muted font-weight-bold font-size-sm">6
                                                mins</span>
                                        </div>
                                    </div>
                                    <!--end:User-->
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mb-5">
                                        ...
                                        <div class="d-flex flex-column align-items-end">
                                            <span class="text-muted font-weight-bold font-size-sm">4
                                                hrs</span>
                                        </div>
                                    </div>
                                    <!--end:User-->
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mb-5">
                                        ...
                                        <div class="d-flex flex-column align-items-end">
                                            <span class="text-muted font-weight-bold font-size-sm">1
                                                week</span>
                                        </div>
                                    </div>
                                    <!--end:User-->
                        ...
                        <div class="card card-custom">
                            ...
                            <div class="card-header align-items-center px-4 py-3">
                                ...
                                <div class="text-center flex-grow-1">
                                    <div class="text-dark-75 font-weight-bold font-size-h5">Matt Pears
                                    </div>
                                    <div>
                                    ...
                                    <div class="messages">
                                        ...
                                        <div class="d-flex flex-column mb-5 align-items-end">
                                            ...
                                            <div
                                                ...
                                                Design. Essential Training also viewed</div>
                                        </div>
                                        <!--end::Message Out-->
                                        <!--begin::Message In-->
                                        <div class="d-flex flex-column mb-5 align-items-start">
