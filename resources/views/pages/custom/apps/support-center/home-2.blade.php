            ...
            <div class="container">
                ...
                <div class="card card-custom overflow-hidden position-relative mb-8">
                    ...
                    <div class="position-absolute bottom-0 left-0 right-0 d-none d-lg-flex flex-row-fluid">
                        <span class="svg-icon svg-icon-full flex-row-fluid svg-icon-dark opacity-3">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1"
                                id="Layer_1" x="0px" y="0px" viewBox="0 0 1200 172"
                    ...
                    <div class="card-body d-flex justify-content-center flex-column col-lg-6 px-8 py-20 px-lg-20 py-lg-40">
                        <!--begin::Heading-->
                        <h2 class="text-dark font-weight-bolder mb-8">How Can We Help?</h2>
                        <!--end::Heading-->
                        <!--begin::Form-->
                        <form class="d-flex position-relative flex-row-fluid">
                            <div class="input-group shadow-sm">
                                ...
                                <!--end::Icon-->
                                <!--begin::Input-->
                                <input type="text" class="form-control h-auto border-0 py-7 px-1 font-size-lg"
                    ...
                    <div class="position-relative px-20">
                        <ul class="nav nav-tabs nav-tabs-line" role="tablist">
                            ...
                            <li class="nav-item mr-14 mt-4">
                                <a class="nav-link font-size-h5 font-weight-bold border-2 pb-6 mx-0 active"
                                    data-toggle="tab" href="#kt_tabs_6_1">Get Started</a>
                            </li>
                            <!--end::Nav Item-->
                            <!--begin::Nav Item-->
                            <li class="nav-item mr-14 mt-4">
                                <a class="nav-link font-size-h5 font-weight-bold border-2 pb-6 mx-0" data-toggle="tab"
                                    href="#kt_tabs_6_2">Video Tutorials</a>
                            </li>
                            <!--end::Nav Item-->
                            <!--begin::Nav Item-->
                            <li class="nav-item mr-14 mt-4">
                                <a class="nav-link font-size-h5 font-weight-bold border-2 pb-6 mx-0" data-toggle="tab"
                                    href="#kt_tabs_6_3">License Terms</a>
                            </li>
                            <!--end::Nav Item-->
                            <!--begin::Nav Item-->
                            <li class="nav-item mr-14 mt-4">
                                <a class="nav-link font-size-h5 font-weight-bold border-2 pb-6 mx-0" data-toggle="tab"
                                    href="#kt_tabs_6_4">Copyright</a>
                            </li>
                            <!--end::Nav Item-->
                            <!--begin::Nav Item-->
                            <li class="nav-item mr-14 mt-4">
                                <a class="nav-link font-size-h5 font-weight-bold border-2 pb-6 mx-0" data-toggle="tab"
                                    href="#kt_tabs_6_5">Tax &amp; Compliance</a>
                            </li>
                            <!--end::Nav Item-->
                            <!--begin::Nav Item-->
                            <li class="nav-item mt-4">
                                <a class="nav-link font-size-h5 font-weight-bold border-2 pb-6 mx-0" data-toggle="tab"
                                    href="#kt_tabs_6_6">Support</a>
                            </li>
                            <!--end::Nav Item-->
                        </ul>
                    </div>
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-header" id="headingOne7">
                                                <div class="card-title" data-toggle="collapse"
                                                    data-target="#collapseOne7" aria-expanded="true" role="button">
                                    ...
                                    <div class="accordion accordion-light accordion-light-borderless accordion-svg-toggle"
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-header" id="headingOne8">
                                                <div class="card-title" data-toggle="collapse"
                                                    ...
                                                    aria-controls="collapseOne8" role="button">
                                                    <span class="svg-icon svg-icon-primary">
                                                        <!--begin::Svg Icon | path:assets/media/svg/icons/Navigation/Angle-double-right.svg-->
                                                        <svg xmlns="http://www.w3.org/2000/svg"
                                                            xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                                            ...
                                            <div id="collapseOne8" class="collapse show" aria-labelledby="headingOne8"
                                                ...
                                                <div class="card-body text-dark-50 font-size-lg pl-12">Anim pariatur cliche
                                                    ...
                                                    sunt aliqua put a bird on it squid single-origin coffee nulla assumenda
                                                    shoreditch et. Nihil anim keffiyeh helvetica, craft beer labore wes
                                                    anderson cred nesciunt sapiente ea proident. raw denim aesthetic synth
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-header" id="headingTwo8">
                                                <div class="card-title collapsed" data-toggle="collapse"
                                                    data-target="#collapseTwo8" aria-expanded="true"
                                                    aria-controls="collapseTwo8" role="button">
                                                    <span class="svg-icon svg-icon-primary">
                                                        <!--begin::Svg Icon | path:assets/media/svg/icons/Navigation/Angle-double-right.svg-->
                                                        <svg xmlns="http://www.w3.org/2000/svg"
                                                            xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-header" id="headingThree8">
                                                <div class="card-title collapsed" data-toggle="collapse"
                                                    data-target="#collapseThree8" aria-expanded="true"
                                                    aria-controls="collapseThree8" role="button">
                                                    <span class="svg-icon svg-icon-primary">
                                                        <!--begin::Svg Icon | path:assets/media/svg/icons/Navigation/Angle-double-right.svg-->
                                                        <svg xmlns="http://www.w3.org/2000/svg"
                                                            xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                            ...
                            <div class="card-body">
                                <div class="p-4">
                                    <div class="d-flex justify-content-between align-items-center mb-8">
                                        <!--begin::Heading-->
                                        <h2 class="text-dark">AirPlus SAAS License</h2>
                                        <!--end::Heading-->
                                        <!--begin::Badge-->
                                        <div class="btn btn-text btn-sm btn-light-primary font-weight-bolder">Blog</div>
                                        <!--end::Badge-->
                                    </div>
                                    <!--begin::Content-->
                            ...
                            <div class="card-body">
                                <div class="p-4">
                                    <div class="d-flex justify-content-between align-items-center mb-8">
                                        ...
                                        <!--end::Heading-->
                                        <!--begin::Badge-->
                                        <div class="btn btn-text btn-sm btn-light-success font-weight-bolder">Blog</div>
                                        <!--end::Badge-->
                                    </div>
                                    <!--begin::Content-->
                                    <div class="text-dark-50 font-size-lg">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        ...
                                        <p class="text-dark-50 font-size-lg">Windows 10 automatically installs updates to
                                            make for sure</p>
                                    </div>
                                    <!--end::Content-->
                                    <!--begin::Button-->
