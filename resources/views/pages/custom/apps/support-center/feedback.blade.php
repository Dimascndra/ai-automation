                        ...
                        <div class="offset-md-3 col-md-6">
                            <span class="svg-icon svg-icon-full">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                    id="ae37f038-3a9e-4b82-ad68-fc94ba16af2a" data-name="Layer 1" width="1096"
                                    height="574.74" viewBox="0 0 1096 574.74">
                                    <g opacity="0.1">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control form-control-solid form-control-lg"
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center justify-content-between p-4">
                                    ...
                                    <div class="d-flex flex-column mr-5">
                                        <a href="#" class="h4 text-dark text-hover-primary mb-5">Or Reach Us by Live
                                            Chat</a>
                        ...
                        <div class="card card-custom mb-2 bg-diagonal bg-diagonal-light-success">
                            <div class="card-body">
                                <div class="d-flex align-items-center justify-content-between p-4">
                                    <!--begin::Content-->
                                    <div class="d-flex flex-column mr-5">
                                        <a href="#" class="h4 text-dark text-hover-primary mb-5">Phone Call</a>
                                        <p class="text-dark-50">Windows 10 automatically installs updates
                                            <br />to make for sure
                                        </p>
                                    </div>
